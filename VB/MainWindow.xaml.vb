...
Namespace PagedAsyncSourceSample
    Partial Public Class MainWindow
        ...
        Public Sub New()
            ...
            Dim source = New PagedAsyncSource() With { _
        ...
        Private Shared Async Function FetchRowsAsync(ByVal e As FetchPageAsyncEventArgs) As Task(Of FetchRowsResult)
            ...
            Dim issues = Await IssuesService.GetIssuesAsync(page:= e.Skip / e.Take, pageSize:= e.Take, sortOrder:= sortOrder, filter:= filter)
